...
## 🚀 Hướng dẫn sử dụng:
1. Giải nén tệp `quan_ly_ho_so_tuyen_sinh.zip`.
2. Nhấp đúp vào file `index.html` để mở giao diện trên trình duyệt web.
3. Chỉnh sửa mã nguồn trực tiếp bằng VS Code hoặc Notepad++.
